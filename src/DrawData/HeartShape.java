...
public class HeartShape {
	...
	public void display(){
		...
		parent.stroke(shapeColor.getR(), shapeColor.getG(), shapeColor.getB());
		parent.fill(shapeColor.getR(), shapeColor.getG(), shapeColor.getB());
			parent.pushMatrix();		

			parent.ellipse(originalPoint.getX()-(circleSize*1/4), originalPoint.getY()-circleSize*2/3, circleSize/2, circleSize/2);
			parent.ellipse(originalPoint.getX()+(circleSize*1/4), originalPoint.getY()-circleSize*2/3, circleSize/2, circleSize/2);
			parent.triangle(
					originalPoint.getX() - circleSize/2.0f, originalPoint.getY()-circleSize*2/3,
					originalPoint.getX(), originalPoint.getY(),
					originalPoint.getX(), originalPoint.getY()- circleSize*2/3
			);
			parent.triangle(
					originalPoint.getX() + circleSize/2.0f, originalPoint.getY()-circleSize*2/3,
					originalPoint.getX(), originalPoint.getY(),
